...
TAX_TYPES: tuple[TaxType, ...] = (
    ...
    TaxType("property", "房屋稅／土地稅", (
        "土地增值税", "土地增值稅",
        "房屋税", "房屋稅", "土地税", "土地稅", "契税", "契稅",
        "房产税", "房產稅", "城镇土地使用税", "城鎮土地使用稅",
        "耕地占用税", "耕地占用稅",
    )),
    TaxType("vat", "增值稅／營業稅", (
    ...
    TaxType("collection", "稅捐稽徵", (
        "税收征收管理", "稅捐稽徵", "征管法", "徵管法",
        "税务登记", "稅務登記", "纳税申报", "納稅申報", "申报表", "申報表",
        "代扣代缴", "代扣代繳", "发票", "發票", "征管", "徵管",
        "稽查", "涉税", "涉稅", "纳税信用", "納稅信用",
        "税收违法", "稅收違法", "欠税", "欠稅", "催缴", "催繳",
        "纳税人识别", "納稅人識別", "税务行政", "稅務行政",
    )),
)
